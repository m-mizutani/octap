...
func (d *ProgressDisplayManager) Clear() {
...
func (d *ProgressDisplayManager) ShowWaiting(commitSHA, repoName string) {
	// Not used in this implementation
}

func (d *ProgressDisplayManager) ShowCountdown(remaining time.Duration) {
...
func (d *ProgressDisplayManager) getProgressBar() string {
	if d.totalCount == 0 {
		return "⏳"
	}
